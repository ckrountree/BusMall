...
// begin voting count at zero (0) and store data at point of last click
//       so that clicks can be picked up again after refresh
var tracker = {
...
//  declare a variable set to the first array to  ensure that same-images do not appear on next sequential page
...
localStorage.setItem( 'currentVote', JSON.stringify(tracker.votes ));
